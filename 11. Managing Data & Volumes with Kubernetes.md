<div style="display: flex; justify-content: space-between;">
  <a href="10.%20Kubernetes%20in%20Action.md" style="padding: 5px 10px; background-color: gray; color: white; text-decoration: none; border-radius: 5px;font-size: 12px">&laquo; Back</a>
  <div> </div>
</div>
...
<div style="display: flex; justify-content: space-between;">
  <div> 
    <a href="10.%20Kubernetes%20in%20Action.md" style="padding: 5px 10px; background-color: gray; color: white; text-decoration: none; border-radius: 5px;font-size: 12px">&laquo; Prev: Kubernetes in Action</a>
  </div>
  <div>
    <a href="12.%20Kubernetes%20Networking.md" style="padding: 5px 10px; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px;font-size: 12px">Next: Kubernetes Networking &raquo;</a>
  </div>
</div>